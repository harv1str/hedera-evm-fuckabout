...
contract UniswapV2Factory is IUniswapV2Factory {
    ...
    function getPairAddress(address _tokenA, address _tokenB) public view returns (address){
      address pairA = getPair[_tokenA][_tokenB];
      address pairB = getPair[_tokenB][_tokenA];
      
      require(pairA != address(0) && pairB != address(0), 'Pair Does not Exist');

      return pairA != address(0)? pairA : pairB;
    }
