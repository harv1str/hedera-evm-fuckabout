...
const helloWorld = require("../contracts/stateful_modified.json");
...
async function main() {
    ...
    const contract_owner = contractOwnerCallResult;

    console.log(contract_owner.contractId.toString())
    //console.log(contract_owner.bytes.toString('hex'));
    //console.log(contract_owner.bytes.toString('utf8'));

    console.log(`contract message: ${message} for owner: `);
